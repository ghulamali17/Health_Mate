...
const Healthmate = () => {
  ...
  useEffect(() => {
    const fetchCurrentUser = async () => {
      try {
        ...
        const response = await axios.get("https://health-mate-3x6x-h4sg0hzj5-ghulam-alis-projects-b7b1d0e4.vercel.app/api/users/current", {
  ...
  const fetchSessions = async () => {
    if (!user) return;
    try {
      const response = await axios.get(`https://health-mate-3x6x-h4sg0hzj5-ghulam-alis-projects-b7b1d0e4.vercel.app/api/chat/sessions/${user._id}`);
  ...
  const loadChatHistory = async () => {
    ...
    try {
      const response = await axios.get(
        `https://health-mate-3x6x-h4sg0hzj5-ghulam-alis-projects-b7b1d0e4.vercel.app/api/chat/history/${user._id}/${sessionId}`
      );
  ...
  const saveChatMessage = async (message) => {
    if (!user || !sessionId) return;
    try {
      await axios.post("https://health-mate-3x6x-h4sg0hzj5-ghulam-alis-projects-b7b1d0e4.vercel.app/api/chat/save", {
        userId: user._id,
        sessionId,
        message,
      });
  ...
  const deleteSession = async (sessionIdToDelete) => {
    if (!user) return;
    try {
      await axios.delete(`https://health-mate-3x6x-h4sg0hzj5-ghulam-alis-projects-b7b1d0e4.vercel.app/api/chat/session/${user._id}/${sessionIdToDelete}`);
      fetchSessions();
  ...
  const handleTextSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://health-mate-3x6x-h4sg0hzj5-ghulam-alis-projects-b7b1d0e4.vercel.app/api/healthmate", {
        method: "POST",
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      const res = await fetch("https://health-mate-3x6x-h4sg0hzj5-ghulam-alis-projects-b7b1d0e4.vercel.app/api/summarize", {
        method: "POST",
        body: formData,
      });
