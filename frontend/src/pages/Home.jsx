  ...
  const features = [
    {
      ...
      description: "Monitor BP, sugar, weight, temperature, and heart rate with AI-powered insights and trend analysis."
    },
    {
      icon: <Brain className="w-6 h-6" />,
      title: "AI Report Analysis",
      description: "Upload medical reports and get instant AI summaries in English + Roman Urdu with actionable advice."
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Family Health Hub",
      description: "Track health records for your entire family - parents, children, and relatives in one place."
    },
    {
      icon: <MessageSquare className="w-6 h-6" />,
      title: "Health AI Assistant",
      description: "Ask health questions anytime and get personalized guidance from our intelligent chatbot."
    },
    {
      icon: <BarChart3 className="w-6 h-6" />,
      title: "Visual Analytics",
      description: "Beautiful charts and graphs show your health trends over time with predictive insights."
    },
    {
  ...
  const testimonials = [
    {
      ...
      content: "HealthMate ne meri zindagi asaan kar di! Ab mai apne father ki sugar levels track kar sakta hun aur AI mujhe batata hai ke kya khana chahiye.",
      avatar: "👨‍💼",
      rating: 5
    },
    {
      ...
      content: "I recommend HealthMate to all my patients. The AI report summaries help them understand their results before our consultation.",
      avatar: "👩‍⚕️",
      rating: 5
    },
    {
      ...
      content: "Vaccination records, growth tracking, sab kuch ek jagah! Ab mai apne bacchon ki health easily manage kar sakti hun.",
      avatar: "👩‍👧‍👦",
      rating: 5
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Upload medical reports, track vitals, and get instant AI analysis in English + Roman Urdu. 
                Your family's health, simplified and secured.
              </p>
            ...
            <div className="relative">
              ...
              <div className="relative bg-white rounded-3xl p-8 shadow-2xl border border-green-100">
                <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 text-lg">Recent Check-up</h3>
                    <p className="text-sm text-gray-500">Ali Ahmed • Today, 10:30 AM</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-5 border-2 border-green-100 hover:border-green-300 transition-all">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-xs font-semibold text-gray-600 uppercase">BP</span>
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-5 border-2 border-blue-100 hover:border-blue-300 transition-all">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-xs font-semibold text-gray-600 uppercase">Sugar</span>
                    </div>
                    <p className="text-2xl font-bold text-gray-900">95</p>
                    <p className="text-xs text-blue-600 font-medium mt-1">Perfect ✓</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-5 border-2 border-purple-100 hover:border-purple-300 transition-all">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-xs font-semibold text-gray-600 uppercase">Weight</span>
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl p-5 border-2 border-red-100 hover:border-red-300 transition-all">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-xs font-semibold text-gray-600 uppercase">Heart</span>
                    </div>
                    <p className="text-2xl font-bold text-gray-900">72 bpm</p>
                    <p className="text-xs text-red-600 font-medium mt-1">Healthy ✓</p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              ...
              <span className="bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent"> One Place</span>
            </h2>
            ...
            {quickActions.map((action, index) => (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className={`w-14 h-14 bg-gradient-to-br ${action.gradient} rounded-2xl flex items-center justify-center shadow-md mb-4 group-hover:scale-110 transition-transform`}>
                    {action.icon}
                  </div>
      ...
      <section id="features" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Smart Features for
              <span className="bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent"> Better Health</span>
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <h2 className="text-4xl font-bold mb-6">
                Upload Report,
                <br />Get Instant AI Analysis
              </h2>
              <p className="text-lg text-green-50 mb-8 leading-relaxed">
                Our AI understands medical reports in English and Urdu. Upload any lab report, prescription, or X-ray, 
                and get a detailed summary with foods to eat/avoid and questions to ask your doctor - sab kuch Roman Urdu mein bhi!
              </p>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center gap-3">
                  <Check className="w-6 h-6 text-green-200 flex-shrink-0" />
                  <span className="text-green-50">Bilingual explanations (English + Roman Urdu)</span>
                </li>
                <li className="flex items-center gap-3">
                  <Check className="w-6 h-6 text-green-200 flex-shrink-0" />
                  <span className="text-green-50">Dietary recommendations based on your results</span>
                </li>
                <li className="flex items-center gap-3">
                  <Check className="w-6 h-6 text-green-200 flex-shrink-0" />
                  <span className="text-green-50">Questions to ask your doctor for better consultations</span>
                </li>
              </ul>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-2xl">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">CBC Report • Analyzed in 3s</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-green-50 rounded-xl border-l-4 border-green-500">
                    ...
                    <p className="text-sm text-gray-600">Overall health is good. Hemoglobin slightly low...</p>
                  </div>

                  <div className="p-4 bg-yellow-50 rounded-xl border-l-4 border-yellow-500">
                    <p className="text-sm font-semibold text-gray-900 mb-1">⚠️ Abnormal Values</p>
                    <p className="text-sm text-gray-600">Hemoglobin: 11.5 g/dL (Normal: 12-16)</p>
                  </div>

                  <div className="p-4 bg-blue-50 rounded-xl border-l-4 border-blue-500">
                    <p className="text-sm font-semibold text-gray-900 mb-1">🥗 Foods to Eat</p>
                    <p className="text-sm text-gray-600">Spinach, dates, red meat, lentils...</p>
                  </div>

                  <div className="p-4 bg-purple-50 rounded-xl border-l-4 border-purple-500">
                    <p className="text-sm font-semibold text-gray-900 mb-1">Roman Urdu</p>
                    <p className="text-sm text-gray-600 italic">Palak aur khajoor khayein...</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="testimonials" className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Stories from
              <span className="bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent"> Happy Families</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-white rounded-2xl p-8 shadow-lg border-2 border-green-100 hover:border-green-300 transition-all">
      ...
      <section className="py-24 bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center px-6 relative">
          ...
          <p className="text-xl text-green-100 mb-10 max-w-2xl mx-auto leading-relaxed">
            Join thousands of families using HealthMate to stay healthy, organized, and informed.
            Apni sehat ko behtar banayen - start karein aaj hi!
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Your smart health companion for better family wellness. Sehat ka smart dost!
              </p>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © 2025 HealthMate. All rights reserved. Made with 💚 in Pakistan.
            </p>
...
export default HealthMateLanding;