...
const healthlensRouter = require("./routes/healthlensRoutes");
...
app.use("/api/healthlens", healthlensRouter);
...
app.get("/", (req, res) => {
  res.json({
    message: "HealthLens Backend API is running!",
    version: "1.0.0",
    environment: process.env.NODE_ENV || "development",
    endpoints: {
      healthlens: "/api/healthlens",
